      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-xl text-primary">Paginate.dev</h3>
            <p className="text-muted-foreground">Where programmers connect, showcase their work, and grow together.</p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Link href="/programmers" className="block text-muted-foreground hover:text-primary transition-colors">
                Browse Programmers
              </Link>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center text-muted-foreground">
          <p>&copy; 2024 Paginate.dev. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
