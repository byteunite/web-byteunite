...
const portfolioData = [
  ...
  },
  {
    ...
    description: "Reusable UI component library with Storybook documentation and automated testing.",
    author: "James Wilson",
    authorId: 6,
    category: "frontend",
  ...
  },
  {
    ...
    description: "Complete CI/CD pipeline with automated testing, deployment, and monitoring for web applications.",
    author: "Elena Volkov",
    authorId: 5,
    category: "backend",
...
export default function PortfolioPage() {
  ...
  const allTechnologies = Array.from(new Set(portfolioData.flatMap((project) => project.stack))).sort()
        ...
        <div className="container mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Discover amazing projects built by our community members. Get inspired and showcase your own work.
            </p>
          </div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {featuredProjects.map((project) => (
                <Card key={project.id} className="pt-0 hover:shadow-lg transition-all duration-300 hover:scale-105">
                  ...
                  <CardHeader>
                    ...
                    <CardDescription className="text-sm">
                      by{" "}
                      <Link href={`/programmers/${project.authorId}`} className="text-primary hover:underline">
                        {project.author}
                      </Link>
                    </CardDescription>
                  </CardHeader>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            {searchTerm || selectedCategory !== "all" || selectedTech !== "all" ? "Search Results" : "All Projects"}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProjects.map((project) => (
              <Card key={project.id} className="pthover:shadow-lg transition-all duration-300 hover:scale-105">
                <div className="relative">
                  <img
                    src={project.image || "/placeholder.svg?height=200&width=400"}
                    alt={project.title}
      ...
      <section className="py-16 px-4 bg-muted/30">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Join our community and showcase your projects to thousands of developers.
          </p>
